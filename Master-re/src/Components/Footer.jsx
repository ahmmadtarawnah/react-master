...
const Footer = () => {
  return (
    <footer className="bg-[#2B3B3A] pt-12 pb-6 px-10 font-[sans-serif] tracking-wide">
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <li>
                <Link to="#" className="transition-colors duration-300">
                  <svg
                    ...
                    className="fill-[#AF8E4D] hover:fill-white w-7 h-7"
                    viewBox="0 0 24 24"
                  >
                    <path
                      fillRule="evenodd"
          ...
          <div>
            <h4 className="text-[#AF8E4D] text-lg mb-6 font-semibold">
              Useful Links
            </h4>
            <ul className="space-y-4 pl-2">
              <li>
                <Link
                  to="#"
                  className="text-[#AF8E4D] hover:text-white text-sm transition-colors duration-300"
                >
                  Featured
                </Link>
              </li>
        ...
        <p className="text-[#AF8E4D] text-sm mt-10 text-center">
